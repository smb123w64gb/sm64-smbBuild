...
### Current Goals for my build
- [ ] Rustify the source code
- [ ] Make qualitys of life, Maybe create archive format for Assets
- [ ] Have seperate app to extract Assets from ROMs to archive
- [x] Have Fun!
